...
export async function loader({ request }: { request: Request }) {
  ...
  if (shop) {
    // TODO: Hier würden wir prüfen, ob der Shop bereits das Onboarding abgeschlossen hat
    // Für jetzt nehmen wir an, dass wenn die App embedded aufgerufen wird, das Onboarding abgeschlossen ist
    if (embedded === "1") {
